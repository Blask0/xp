    ...
    implements JaxRsComponent
{
    ...
    private Applications filterApplications( final Applications applications, final String query )
    {
        if ( !Strings.nullToEmpty( query ).isBlank() )
        {
            ...
            return Applications.from( applications.stream().
                filter( application -> Strings.nullToEmpty( application.getDisplayName() ).toLowerCase().contains( queryLowercase ) ||
                    Strings.nullToEmpty( application.getMaxSystemVersion() ).toLowerCase().contains( queryLowercase ) ||
                    Strings.nullToEmpty( application.getMinSystemVersion() ).toLowerCase().contains( queryLowercase ) ||
                    Strings.nullToEmpty( application.getSystemVersion() ).toLowerCase().contains( queryLowercase ) ||
                    Strings.nullToEmpty( application.getUrl() ).toLowerCase().contains( queryLowercase ) ||
                    Strings.nullToEmpty( application.getVendorName() ).toLowerCase().contains( queryLowercase ) ||
                    Strings.nullToEmpty( application.getVendorUrl() ).toLowerCase().contains( queryLowercase ) ).
                collect( Collectors.toList() ) );
        }
